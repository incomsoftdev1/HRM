...
Функция СтандартныеВычетыНастройки(Дата) Экспорт
	...
	НастройкиСтруктура.Вставить("МаксимальнаяСуммаНаДетей");
	НастройкиСтруктура.Вставить("МРОТ");
...
Функция ПолучитьРабочиеДниЧасыЗаМесяц(МесяцНачисления) Экспорт
	...
	Если ПроизводственныйКалендарьРФ <> Неопределено Тогда
		...
		РабочихДнейЧасов = инкРасчетЗарплатыБазовый.РабочихДнейЧасовВПериоде(ПроизводственныйКалендарьРФ, НачалоМесяца(МесяцНачисления), КонецМесяца(МесяцНачисления));
