...
Процедура ПрочиеУдержания_Расчет(ДанныеНачисленияЗарплаты)
	...
	Для каждого элСотрудник из СотрудникиМассив Цикл
		...
		Для каждого стрТабличнаяЧасть из массТабличнаяЧасть Цикл
			...
			Если стрТабличнаяЧасть.Удержание = ПланыВидовРасчета.инкУдержания.Алименты Тогда
				АлиментыЧисло = АлиментыЧисло + стрТабличнаяЧасть.СуммаУдержания;	
		...
		Для каждого стрТабличнаяЧасть из массТабличнаяЧасть Цикл
			...
			стрТабличнаяЧасть.Алименты = АлиментыЧисло;
...
Процедура Ведомость_Расчет(ДанныеНачисленияЗарплаты)
	...
	Для каждого стрСотрудник из ДанныеНачисленияЗарплаты.СотрудникиМассив Цикл
		...
		Для каждого ВедомостьСтрока из ВедомостьМассив Цикл
			...
			ОкладСотрудника = ВедомостьСтрока.ОкладРазмер;
			Если НЕ ЗначениеЗаполнено(ОкладСотрудника) Тогда
				ОкладСотрудника = ВедомостьСтрока.Сотрудник.Оклад;	
			КонецЕсли;
			ВедомостьСтрока.Оклад = ОкладСотрудника * чКоэффициентДни; 
